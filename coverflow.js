...
coverflowimages({
	coverid: 'coverflow1',
	images: [
				['./assets/1.jpg', './assets/1.jpg', 'Angelina Jolie, is an American actress and filmmaker, and an Academy Award winner'],
				['./assets/2.jpg', './assets/2.jpg', 'Milla Jovovich was born in Ukraine and immigrated with her parents to the United States when she\'s five.'],
				['./assets/3.jpg', './assets/3.jpg'],
				['./assets/4.jpg', './assets/4.jpg', 'Hayden Panettiere is a native of New York, and first appeared in a commercial at the age of 11 months.'],
				['./assets/5.jpg', './assets/5.jpg', 'Ashley was born in Granada Hills, California. She is the daughter of Naomi Judd, a country music singer and motivational speaker'] // <-- no comma after last image
			] 
})